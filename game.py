...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, clearTroops, spawnInArcher, move_inarchers, spawnHealer, move_healers
...
while(True):
    ...
    if ch == 'w':
        ...
        spawnInArcher(V.spawn_points[0])
    elif ch == '6':
        spawnInArcher(V.spawn_points[1])
    elif ch == '7':
        spawnInArcher(V.spawn_points[2])
    ...
    move_inarchers(V,pt.movement, King)
    move_dragons(V, King)
